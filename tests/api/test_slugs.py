...
from noether.ledger.models_base import SLUG_MAX_LENGTH, slug_or_uuid_filters, validate_slug
...
class SlugApiTests(NoetherAPITestCase):
    ...
    def test_retrieve_by_unknown_uuid_404(self):
        url = self.ledger_url(f"accounts/{uuid.uuid4()}/")
